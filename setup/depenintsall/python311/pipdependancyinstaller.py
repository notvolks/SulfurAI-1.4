...
class run:
    ...
    def run(self, print_debug: bool = False, RUN_INSTALLER: bool = True):
        ...
        MODULE_IMPORT_MAP = {
            ...
            "flet": {"package": "flet==0.28.3", "imports": ["flet"], "extras": []},
            "flet-charts": {"package": "flet-charts", "imports": ["flet_charts"], "extras": []},
            "plotly": {"package": "plotly", "imports": ["plotly"], "extras": []},
            ...
            # External_auth_app
            "python-oauth2": {"package": "python-oauth2", "imports": ["oauth2"], "extras": []},
            "google-auth-oauthlib": {"package": "google-auth-oauthlib", "imports": ["google_auth_oauthlib.flow"],
                                     "extras": []},
            "google-api-python-client": {"package": "google-api-python-client",
                                         "imports": ["googleapiclient.discovery"], "extras": []},
            "keyring": {"package": "keyring", "imports": ["keyring"], "extras": []},
            "python-dotenv": {"package": "python-dotenv", "imports": ["dotenv"], "extras": []},
            "requests": {"package": "requests", "imports": ["requests"], "extras": []},
